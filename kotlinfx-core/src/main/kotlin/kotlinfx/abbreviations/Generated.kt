...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.stage.Stage.alwaysOnTopp: javafx.beans.property.ReadOnlyBooleanProperty
    get() = alwaysOnTopProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.Scene.userAgentStylesheetp: javafx.beans.property.ObjectProperty<String>
    get() = userAgentStylesheetProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.SubScene.userAgentStylesheetp: javafx.beans.property.ObjectProperty<String>
    get() = userAgentStylesheetProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceBox<T>.onActionp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.event.ActionEvent>>
    get() = onActionProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceBox<T>.onHiddenp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.event.Event>>
    get() = onHiddenProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceBox<T>.onHidingp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.event.Event>>
    get() = onHidingProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceBox<T>.onShownp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.event.Event>>
    get() = onShownProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceBox<T>.onShowingp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.event.Event>>
    get() = onShowingProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.shape.TriangleMesh.vertexFormatp: javafx.beans.property.ObjectProperty<javafx.scene.shape.VertexFormat>
    get() = vertexFormatProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <V> javafx.scene.control.TextFormatter<V>.valuep: javafx.beans.property.ObjectProperty<V>
    get() = valueProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.ChoiceDialog<T>.selectedItemp: javafx.beans.property.ReadOnlyObjectProperty<T>
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.titlep: javafx.beans.property.StringProperty
    get() = titleProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.resultp: javafx.beans.property.ObjectProperty<R>
    get() = resultProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.widthp: javafx.beans.property.ReadOnlyDoubleProperty
    get() = widthProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.graphicp: javafx.beans.property.ObjectProperty<javafx.scene.Node>
    get() = graphicProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.yp: javafx.beans.property.ReadOnlyDoubleProperty
    get() = yProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.onHiddenp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.scene.control.DialogEvent>>
    get() = onHiddenProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.heightp: javafx.beans.property.ReadOnlyDoubleProperty
    get() = heightProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.xp: javafx.beans.property.ReadOnlyDoubleProperty
    get() = xProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.onHidingp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.scene.control.DialogEvent>>
    get() = onHidingProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.showingp: javafx.beans.property.ReadOnlyBooleanProperty
    get() = showingProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.onShownp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.scene.control.DialogEvent>>
    get() = onShownProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.onShowingp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.scene.control.DialogEvent>>
    get() = onShowingProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.resultConverterp: javafx.beans.property.ObjectProperty<javafx.util.Callback<javafx.scene.control.ButtonType, R>>
    get() = resultConverterProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.headerTextp: javafx.beans.property.StringProperty
    get() = headerTextProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.contentTextp: javafx.beans.property.StringProperty
    get() = contentTextProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.dialogPanep: javafx.beans.property.ObjectProperty<javafx.scene.control.DialogPane>
    get() = dialogPaneProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.onCloseRequestp: javafx.beans.property.ObjectProperty<javafx.event.EventHandler<javafx.scene.control.DialogEvent>>
    get() = onCloseRequestProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <R> javafx.scene.control.Dialog<R>.resizablep: javafx.beans.property.BooleanProperty
    get() = resizableProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.chart.PieChart.Data.nodep: javafx.beans.property.ReadOnlyObjectProperty<javafx.scene.Node>
    get() = nodeProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.Spinner<T>.editablep: javafx.beans.property.BooleanProperty
    get() = editableProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.Spinner<T>.valuep: javafx.beans.property.ReadOnlyObjectProperty<T>
    get() = valueProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.Spinner<T>.valueFactoryp: javafx.beans.property.ObjectProperty<javafx.scene.control.SpinnerValueFactory<T>>
    get() = valueFactoryProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.Spinner<T>.editorp: javafx.beans.property.ReadOnlyObjectProperty<javafx.scene.control.TextField>
    get() = editorProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.SpinnerValueFactory.ListSpinnerValueFactory<T>.itemsp: javafx.beans.property.ObjectProperty<javafx.collections.ObservableList<T>>
    get() = itemsProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.TextInputControl.textFormatterp: javafx.beans.property.ObjectProperty<javafx.scene.control.TextFormatter<*>>
    get() = textFormatterProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.TextInputControl.redoablep: javafx.beans.property.ReadOnlyBooleanProperty
    get() = redoableProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.TextInputControl.undoablep: javafx.beans.property.ReadOnlyBooleanProperty
    get() = undoableProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.ScrollPane.minViewportHeightp: javafx.beans.property.DoubleProperty
    get() = minViewportHeightProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.ScrollPane.minViewportWidthp: javafx.beans.property.DoubleProperty
    get() = minViewportWidthProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <X, Y> javafx.scene.chart.LineChart<X, Y>.axisSortingPolicyp: javafx.beans.property.ObjectProperty<javafx.scene.chart.LineChart.SortingPolicy>
    get() = axisSortingPolicyProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.SpinnerValueFactory<T>.valuep: javafx.beans.property.ObjectProperty<T>
    get() = valueProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.SpinnerValueFactory<T>.wrapAroundp: javafx.beans.property.BooleanProperty
    get() = wrapAroundProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val <T> javafx.scene.control.SpinnerValueFactory<T>.converterp: javafx.beans.property.ObjectProperty<javafx.util.StringConverter<T>>
    get() = converterProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.IntegerSpinnerValueFactory.minp: javafx.beans.property.IntegerProperty
    get() = minProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.IntegerSpinnerValueFactory.maxp: javafx.beans.property.IntegerProperty
    get() = maxProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.IntegerSpinnerValueFactory.amountToStepByp: javafx.beans.property.IntegerProperty
    get() = amountToStepByProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.DoubleSpinnerValueFactory.minp: javafx.beans.property.DoubleProperty
    get() = minProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.DoubleSpinnerValueFactory.maxp: javafx.beans.property.DoubleProperty
    get() = maxProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.SpinnerValueFactory.DoubleSpinnerValueFactory.amountToStepByp: javafx.beans.property.DoubleProperty
    get() = amountToStepByProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.expandedp: javafx.beans.property.BooleanProperty
    get() = expandedProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.graphicp: javafx.beans.property.ObjectProperty<javafx.scene.Node>
    get() = graphicProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.headerTextp: javafx.beans.property.StringProperty
    get() = headerTextProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.contentTextp: javafx.beans.property.StringProperty
    get() = contentTextProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.expandableContentp: javafx.beans.property.ObjectProperty<javafx.scene.Node>
    get() = expandableContentProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.headerp: javafx.beans.property.ObjectProperty<javafx.scene.Node>
    get() = headerProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.DialogPane.contentp: javafx.beans.property.ObjectProperty<javafx.scene.Node>
    get() = contentProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.Node.accessibleTextp: javafx.beans.property.ObjectProperty<String>
    get() = accessibleTextProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.Node.accessibleHelpp: javafx.beans.property.ObjectProperty<String>
    get() = accessibleHelpProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.Node.accessibleRolep: javafx.beans.property.ObjectProperty<javafx.scene.AccessibleRole>
    get() = accessibleRoleProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.Node.accessibleRoleDescriptionp: javafx.beans.property.ObjectProperty<String>
    get() = accessibleRoleDescriptionProperty()!!

// javafx.scene.control.Alert

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.Alert.alertTypep: javafx.beans.property.ObjectProperty<javafx.scene.control.Alert.AlertType>
    get() = alertTypeProperty()!!
...
@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.ButtonBar.buttonMinWidthp: javafx.beans.property.DoubleProperty
    get() = buttonMinWidthProperty()!!

@suppress("UNNECESSARY_NOT_NULL_ASSERTION")
public val  javafx.scene.control.ButtonBar.buttonOrderp: javafx.beans.property.StringProperty
    get() = buttonOrderProperty()!!
